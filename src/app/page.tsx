    ...
    <>
      ...
      <section className="relative isolate overflow-hidden bg-[#eef5fb] text-ink">
        <Image
          ...
          quality={100}
          sizes="100vw"
          className="z-0 object-cover object-[48%_top] sm:object-center"
        />
        <div className="absolute inset-0 z-0 bg-[linear-gradient(90deg,rgba(247,251,255,0.99)_0%,rgba(247,251,255,0.98)_58%,rgba(247,251,255,0.9)_76%,rgba(238,245,251,0.16)_100%)] sm:bg-[linear-gradient(90deg,rgba(247,251,255,0.99)_0%,rgba(247,251,255,0.94)_38%,rgba(238,245,251,0.24)_56%,rgba(238,245,251,0)_100%)]" />
